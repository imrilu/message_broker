...
import db_impl as data_handler
import time
...
def app_help():
    return jsonify(message="Welcome to Fireblocks HW assignment. "
                           "This API is used to publish and retrieve messages between clients.",
                   endpoints=
